                 ...
                 <div class="col-md-3">
                    <div class="contact-email text-left">
                      ...
                      <input type="file" class="form-control" @change="onImageChange($event)">
                       <img v-if="employee.photo" :src="employee.photo" style="height:70px">
                       <img v-else :src="url+'images/employee/'+employee.image" style="height:70px">
                      <span
...
export default {
  ...
  mounted() {
     ...
     var _this = this;
     EventBus.$on('edit-employee',function(employee) {
  ...
  methods: {
    ...
    save() {
      ...
      axios
        .put(base_url + "employee/"+this.employee.id, this.employee)
        .then(response => {
