                  ...
                  <div class="col-md-4">
                    <div class="contact-name text-left">
                      ...
                      <select
                        ...
                        id=""
                        class="form-control"
                        v-model="quotation.update_status"
                      >
                        <option value="1">Update</option>
                        <option value="2">Regenerate</option>
                      </select>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  mounted() {
    var _this = this;
    EventBus.$on("edit-quotation", function (quotation) {
      _this.quotation = quotation;
      _this.quotation.update_status = 1;
  ...
  methods: {
    save() {
      ...
      axios
        .put(base_url + "quotation/" + this.quotation.id, this.quotation)
        .then((response) => {
