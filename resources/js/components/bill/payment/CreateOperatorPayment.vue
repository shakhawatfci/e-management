<template>
        <!-- Modal -->
    <div class="modal animated rotateInDownLeft custo-rotateInDownLeft" id="CreateOperatorPayment" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl custom-modal" role="document" >
            <form @submit.prevent="save()">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" v-if="bill">Pyament  For {{ bill.operator.name }} {{ bill.equipement.eq_name }} in
                        ...
                        <div class="add-contact-content text-left">
                                ...
                                <div class="col-md-3">
                                    <div class="contact-name">
                                        ...
                                        id="basicFlatpickr5" class="form-control" placeholder="Payment Date">
                                ...
                                <div class="col-md-3">
                                        <div class="contact-name">
                                            ...
                                            <input type="text" 
                                            v-model="payment.operator_total_amount"
                                             class="form-control" placeholder="Bill Amount" readonly>
                                            <!-- <span v-if="validation_error.hasOwnProperty('operator_total_amount')" class="text-danger">
                                ...
                                <div class="col-md-3">
                                        <div class="contact-name">
                                            ...
                                            <input type="text" 
                                            :value="payment.operator_payment+payment.operator_adjustment_payment"
                                ...
                                <div class="col-md-3">
                                        <div class="contact-name">
                                            ...
                                            <input type="text" 
                                            :value="payment.outstanding_amount = payment.operator_total_amount - payment.operator_payment + payment.operator_adjustment_payment"
                                             class="form-control" placeholder="Bill Amount" readonly>
                                            <!-- <span v-if="validation_error.hasOwnProperty('operator_total_amount')" class="text-danger">
                                                {{ validation_error.operator_total_amount[0] }}
                                            </span> -->
...
export default {
   ...
   mounted() {
        ...
        var _this = this;
        EventBus.$on('make-operator-payment',function(bill) {
                _this.bill = bill;
                ...
                _this.payment.operator_payment = bill.operator_payment;
 ...
 methods : {
     ...
     save()
     {
         ...
         axios.post(base_url+'operator-payment',this.payment)
         .then(response => {
