<template>
        <!-- Modal -->
    <div class="modal animated rotateInDownLeft custo-rotateInDownLeft" id="ViewProjectPayment" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
...
export default {
   ...
   mounted() {
        var _this = this;
        EventBus.$on('view-project-payment',function(bill) {
                _this.bill = bill;
