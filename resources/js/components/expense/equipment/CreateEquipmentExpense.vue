                    ...
                    <div class="add-contact-box">
                           ...
                           <div class="row">
                              <div class="col-md-4">
                                  <div class="contact-email">
                                      ...
                                      <input type="text" class="form-control" id="invoice" v-model="euqipment.invoice_no" placeholder="Invoice Number" />
                                           <span
                      ...
                      <div class="col-md-12">
                        <div class="contact-phone">
                            ...
                            <input type="text" placeholder="Documents Link" id="documents-link" class="form-control" v-model="euqipment.documents_link">
                            <span
...
export default {
   ...
   mounted() {
    ...
    computed: {
        getTotalExpense(){
            return this.euqipment.expense_category.map(o => o.amount).reduce((a, c) => Number(a) + Number(c),0);
        }
    },
