                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="contact-name">
                      ...
                      <input
                        type="text"
                        v-model="equipment.total_project_amount"
                        id="c-name"
                        class="form-control"
                        placeholder="Total Contact Amount With Project"
                      />
                      <span
                        v-if="
                  ...
                  <div class="col-md-4">
                    <div class="contact-name">
                      ...
                      <input
                        type="text"
                        v-model="equipment.total_vendor_amount"
                        id="c-name"
                        class="form-control"
                        placeholder="Total Contact Amount With Vendor"
                      />
                      <span
                        v-if="
                  ...
                  <div class="col-md-4">
                    <div class="contact-name">
                      ...
                      <input
                        type="text"
                        :value="
                          (equipment.project_rate_per_hour = (
                            equipment.total_project_amount /
                            equipment.total_hour
                          ).toFixed(3))
                        "
                        id="c-name"
                        class="form-control"
                  ...
                  <div class="col-md-4">
                    <div class="contact-name">
                      ...
                      <input
                        type="text"
                        :value="
                          (equipment.vendor_rate_per_hour = (
                            equipment.total_vendor_amount / equipment.total_hour
                          ).toFixed(3))
                        "
                        id="c-name"
                        class="form-control"
                  ...
                  <div class="col-md-4">
                    <div class="contact-name">
                      ...
                      />
                      <span
                        v-if="validation_error.hasOwnProperty('assign_date')"
                        class="text-danger"
                      >
                  ...
                  <div class="col-md-12">
                    <div class="contact-location">
                      ...
                      <textarea
                        ...
                        v-model="equipment.document_links"
                      ></textarea>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    getAssignedEquipment(id) {
      axios
        .get(base_url + "assign-equipment/" + id + "/edit")
        .then((response) => {
          ...
          this.equipment.equipment_type =
            response.data.assigned_equipment.equipment_type_id;
          this.equipment.equipment =
            response.data.assigned_equipment.equipement_id;
          ...
          this.equipment.total_project_amount =
            response.data.assigned_equipment.total_project_amount;
          this.equipment.total_vendor_amount =
            response.data.assigned_equipment.total_vendor_amount;
          this.equipment.project_rate_per_hour =
            response.data.assigned_equipment.project_rate_per_hour;
          this.equipment.vendor_rate_per_hour =
            response.data.assigned_equipment.vendor_rate_per_hour;
          this.equipment.assign_date =
            response.data.assigned_equipment.assign_date;
          this.equipment.document_links =
            response.data.assigned_equipment.documents_link;
        });
    },
    ...
    save() {
      ...
      axios
        .put(base_url + "assign-equipment/" + this.equipment.id, this.equipment)
        .then((response) => {
    ...
    getVendorEquipments() {
      if (
        ...
        Swal.fire({
          ...
          title: "Oops...",
          text:
            "please choose equipment type and vendor both field for equipment list",
        });
        return;
      }
      axios
        .get(
          `${base_url}equipment-by-vendor/${this.equipment.equipment_type}/${this.equipment.vendor}`
        )
        .then((response) => {
