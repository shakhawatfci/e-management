    ...
    <table class="table table-bordered table-hover  mb-4">
        ...
        <tbody>
            ...
            <tr v-if="suppliers.data.length > 0">
                <td colspan="6">
                  <a :href="url+'supplier-list-print-pdf?action=pdf'" class="btn btn-primary btn-sm"><i class="fa fa-file-pdf-o"></i> PDF</a>
                  <a :href="url+'supplier-list-print-pdf?action=print'" class="btn btn-danger btn-sm" target="_blank"><i class="fa fa-file-pdf-o"></i> Print</a>
                </td>
            </tr>
        </tbody>
    </table>
