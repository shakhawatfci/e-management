<template>
<!-- Modal -->
    <div id="createProjectHead" class="modal animated fadeInRight custo-fadeInRight show" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="contact-name">
                                        ...
                                        <input type="text"
                                          class="form-control" id="head-name" v-model="project.head_name" placeholder="Project Head Name">
	                                ...
	                                <div class="col-md-12">
	                                    <div class="contact-email">
	                                        ...
	                                        <select class="form-control" id="head-status" v-model="project.status">
	                                            <option value="">Project Head Status</option>
 ...
 methods : {
     ...
     save()
     {
        this.button_name = "Saving...";
          axios.post(base_url+'project-expense-head',this.project)
          .then(response => {
