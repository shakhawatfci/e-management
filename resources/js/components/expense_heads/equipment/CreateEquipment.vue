<template>
<!-- Modal -->
    <div id="createEquipmentHead" class="modal animated rotateInDownLeft custo-rotateInDownLeft" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="contact-name">
                                        ...
                                        <input type="text"
                                          class="form-control" v-model="equipment.head_name" placeholder="Equipment Head Name">
 ...
 methods : {
     ...
     save()
     {
        this.button_name = "Saving...";
          axios.post(base_url+'expense-equipment',this.equipment)
          .then(response => {
