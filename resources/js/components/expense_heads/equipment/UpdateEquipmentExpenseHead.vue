<template>
<!-- Modal -->
    <div id="UpdateEquipmentHead" class="modal animated fadeInRight custo-fadeInRight show" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
...
export default {
   ...
   mounted() {
      var _this = this;
      EventBus.$on('equipmentExpenseHead-update', function(value){
 ...
 methods : {
     ...
     update()
     {
        this.button_name = "Updating...";
          axios.put(base_url+'expense-equipment/'+this.equipment.id,this.equipment)
          .then(response => {
