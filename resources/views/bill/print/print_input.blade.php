  ...
  @endif
        ...
        <div class="row">
        	<div class="col-md-12 col-xs-12">
               ...
               @endphp
        	   <p>Amount In Words {{ $taka->get_bd_amount_in_text(round(($bill->total_project_amount + $bill->operator_total_amount - $bill->operator_payment),2)) }}</p>
        	</div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-xs-6">
                ...
                <p style="margin-top: 60px;"><input type="text" name="bill_by" value="Md Shafiqul Islam" class="form-control"></p>
                <p><input type="text" name="designation" value="General Manager" class="form-control" required=""></p>
